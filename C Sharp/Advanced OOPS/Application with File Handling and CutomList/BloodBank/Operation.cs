...
namespace BloodBank
{
    public static class Operation
    {
        ...
        public static List<UserRegistrationDetails> userRegistrationList = new List<UserRegistrationDetails>();
        public static List<DonationDetails> donationList = new List<DonationDetails>();
        public static UserRegistrationDetails currentLoginUser;
